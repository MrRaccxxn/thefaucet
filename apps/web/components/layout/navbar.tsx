...
export function Navbar() {
  ...
  return (
    <header className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50">
      <div className="mx-auto px-6 py-3 rounded-full bg-background/70 backdrop-blur-xl border border-border/30 shadow-lg shadow-black/5">
        <div className="flex items-center justify-between min-w-[600px] max-w-4xl">
          {/* Logo */}
